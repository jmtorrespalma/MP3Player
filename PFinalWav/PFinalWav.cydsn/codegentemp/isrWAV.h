...
#define isrWAV_INTC_VECTOR            ((reg32 *) isrWAV__INTC_VECT)
...
#define isrWAV_INTC_SET_EN            ((reg32 *) isrWAV__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the isrWAV interrupt. */
#define isrWAV_INTC_CLR_EN            ((reg32 *) isrWAV__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the isrWAV interrupt state to pending. */
#define isrWAV_INTC_SET_PD            ((reg32 *) isrWAV__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the isrWAV interrupt. */
#define isrWAV_INTC_CLR_PD            ((reg32 *) isrWAV__INTC_CLR_PD_REG)
