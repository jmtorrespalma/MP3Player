...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000030u)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000044u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT0_AMUX, 0x80u);
