...
#define LCD_Char_PORT_MASK                ((uint8) (LCD_Char_LCDPort__MASK))
    ...
    */
    #define LCD_Char_HIGH_Z_DATA_DM           (0x00000249ul)
    #define LCD_Char_STRONG_DATA_DM           (0x00000DB6ul)
    #define LCD_Char_DATA_PINS_MASK           (0x00000FFFul)
    #define LCD_Char_DM_DATA_MASK             ((uint32)(LCD_Char_DATA_PINS_MASK << \
                                                          (LCD_Char_PORT_SHIFT * 3u)))
...
/* Pin Masks */
#define LCD_Char_RS                     ((uint8) \
                                                (((uint8) 0x20u) << LCD_Char_LCDPort__SHIFT))
#define LCD_Char_RW                     ((uint8) \
                                                (((uint8) 0x40u) << LCD_Char_LCDPort__SHIFT))
#define LCD_Char_E                      ((uint8) \
                                                (((uint8) 0x10u) << LCD_Char_LCDPort__SHIFT))
#define LCD_Char_READY_BIT              ((uint8) \
                                                (((uint8) 0x08u) << LCD_Char_LCDPort__SHIFT))
#define LCD_Char_DATA_MASK              ((uint8) \
                                                (((uint8) 0x0Fu) << LCD_Char_LCDPort__SHIFT))
