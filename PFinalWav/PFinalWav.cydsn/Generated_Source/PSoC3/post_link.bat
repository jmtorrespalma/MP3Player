...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\Torres\Trabajos\DSE\PracticaFinal\PFinalWav\PFinalWav.cydsn\PFinalWav.svd" rem "C:\Users\Torres\Trabajos\DSE\PracticaFinal\PFinalWav\PFinalWav.cydsn\PFinalWav.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
