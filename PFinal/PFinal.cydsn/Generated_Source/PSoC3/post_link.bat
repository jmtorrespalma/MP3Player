...
CD /D "C:\Keil\UV4"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
IF NOT EXIST "C:\Users\Torres\Trabajos\DSE\PracticaFinal\PFinal\PFinal.cydsn\PFinal.svd" rem "C:\Users\Torres\Trabajos\DSE\PracticaFinal\PFinal\PFinal.cydsn\PFinal.sfr"
@IF %errorlevel% NEQ 0 EXIT /b %errorlevel% 
