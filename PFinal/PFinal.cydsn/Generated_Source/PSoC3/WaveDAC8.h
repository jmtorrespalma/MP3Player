...
#define WaveDAC8_WAVE2_TYPE     (3u)     /* Waveform for wave2 */
...
#define WaveDAC8_WAVE1_LENGTH   (285u)   /* Length for wave1 */
#define WaveDAC8_WAVE2_LENGTH   (4u)   /* Length for wave2 */
	
#define WaveDAC8_DEFAULT_RANGE    (1u) /* Default DAC range */
...
#define WaveDAC8_SetSpeed(speed)      WaveDAC8_VDAC8_SetSpeed(speed)
#define WaveDAC8_SetRange(range)      WaveDAC8_VDAC8_SetRange(range)
#define WaveDAC8_SetValue(value)      WaveDAC8_VDAC8_SetValue(value)
#define WaveDAC8_DacTrim(void)        WaveDAC8_VDAC8_DacTrim()
#define WaveDAC8_SaveConfig(void)     WaveDAC8_VDAC8_SaveConfig()
#define WaveDAC8_RestoreConfig(void)  WaveDAC8_VDAC8_RestoreConfig()
...
#define WaveDAC8_DAC_RANGE      ((uint8)(1u << 2u) & WaveDAC8_RANGE_MASK)
#define WaveDAC8_DAC_POL        ((uint8)(1u >> 1u) & WaveDAC8_IDIR_MASK)
